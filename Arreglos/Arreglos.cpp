...
array<float, LEN> SumarArreglos(array<float, LEN> arr1, array<float, LEN> arr2)
{
/*Para programar nuestra función SumarArreglos declaramos primeramente el arreglo
para posteriormente ejecutar un ciclo for que sumara las entradas de los arreglos
